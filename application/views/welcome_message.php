...
<p><b>Current Members:</b> <?php echo $activeMembers; ?> <a href="<?php echo site_url('supporters/browse/members/current') ?>">Browse</a> | <a href="<?php echo site_url('export/current_members') ?>">Export</a><br />
