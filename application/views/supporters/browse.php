...
<table width="100%"><tr><th>ID</th><th>Name</th><th>Address</th><th>Email</th><th>Phone</th><th>Type</th><th>Status</th><th>Payment</th><th>Posted</th><th>Control</th></tr>
...
foreach ($supporters as $supporter) {
    ...
    echo '<td>Expires on ' . strftime('%d/%m/%y', $supporter['expiration_date']) . '</td>';
